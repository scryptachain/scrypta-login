...
You can even use the IPFS version, the hash is: `QmPThxteG9XA2KcNELqTcopreYEZpeY7N4DhUQ99q3PcN6` like this:

```
<script src="https://ipfs.io/ipfs/QmPThxteG9XA2KcNELqTcopreYEZpeY7N4DhUQ99q3PcN6"></script>
```
